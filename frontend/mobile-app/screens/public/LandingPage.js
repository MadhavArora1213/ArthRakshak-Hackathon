...
const styles = StyleSheet.create({
  ...
  stepsSection: {
    paddingHorizontal: 20,
    paddingVertical: 30,
    backgroundColor: colors.pureWhite[100],
  },
  stepItem: {
    flexDirection: 'row',
  ...
  trustBadge: {
    backgroundColor: colors.infoYellow[100],
    paddingHorizontal: 20,
    paddingVertical: 10,
    borderRadius: 20,
    alignSelf: 'center',
